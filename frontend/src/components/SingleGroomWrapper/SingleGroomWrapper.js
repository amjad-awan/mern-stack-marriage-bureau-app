...
import { Button, Card, CardSubtitle, Col, Row, Spinner } from "reactstrap";
      ...
      <Card className="single-groom-wrapper">
        <Row className="gap-4 mb-3">
          <Col sm={12} md={3}>
            ...
            <CardSubtitle className=" text-muted text-wrapper" tag="h6">
              Age:{" "}
              <span className="info"> {groom?.requirements?.requiredAge}</span>
            </CardSubtitle>
            <CardSubtitle className=" text-muted text-wrapper" tag="h6">
              Height
              <span className="info">
            ...
            <CardSubtitle className=" text-muted text-wrapper" tag="h6">
              City
              <span className="info"> {groom?.requirements?.requiredCity}</span>
            </CardSubtitle>
            <CardSubtitle className=" text-muted text-wrapper" tag="h6">
              Cast
              <span className="info"> {groom?.requirements?.requiredCast}</span>
            </CardSubtitle>
            <CardSubtitle className=" text-muted text-wrapper" tag="h6">
              Qualification
              <span className="info">
            ...
            <CardSubtitle className=" text-muted text-wrapper" tag="h6">
              Sect
              <span className="info"> {groom?.requirements?.requiredSect}</span>
            </CardSubtitle>
          </Col>
        </Row>
      </Card>
